...
use crate::backend::cpu::bit_reverse;
use crate::backend::{Col, ColumnOps};
use crate::circle::{CirclePoint, Coset};
use crate::fft::{butterfly, ibutterfly};
use crate::fields::m31::BaseField;
use crate::fields::qm31::SecureField;
use crate::fields::{batch_inverse_in_place, ExtensionOf};
use crate::poly::circle::{CanonicCoset, CircleDomain, CircleEvaluation, CirclePoly, PolyOps};
use crate::poly::twiddles::TwiddleTree;
use crate::poly::utils::{domain_line_twiddles_from_tree, fold};
use crate::poly::BitReversedOrder;
use crate::utils::coset_order_to_circle_domain_order;
...
impl PolyOps for CpuBackend {
    ...
    fn precompute_twiddles(coset: Coset) -> TwiddleTree<Self> {
        ...
        twiddles
            .chunks(CHUNK_SIZE)
            .zip(itwiddles.chunks_mut(CHUNK_SIZE))
            .for_each(|(src, dst)| {
